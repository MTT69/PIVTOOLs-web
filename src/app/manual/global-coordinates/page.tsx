...
pivtools-cli statistics`}
  ...
  global_coordinates:
    enabled: true
    datum_camera: 1                     # Defaults to 1; rarely changed
                ...
                <table className="min-w-full bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {[
                      ...
                      { field: "datum_camera", type: "int", desc: "Camera that holds the origin. Defaults to Camera 1 and rarely needs changing." },
