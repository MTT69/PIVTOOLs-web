...
const manualSections: ManualSection[] = [
  ...
  },
  {
    ...
    subsections: [
      ...
      { title: 'Predictor & Peak Settings', href: '/manual/piv-processing#predictor-peak' },
      { title: 'Boundary Conditions', href: '/manual/piv-processing#boundary-conditions' },
      { title: 'Correlation & Fitting', href: '/manual/piv-processing#correlation-fitting' },
      ...
      { title: 'NaN Reason Codes', href: '/manual/piv-processing#nan-reason' },
  ...
  },
  {
    ...
    subsections: [
      ...
      { title: 'Polynomial', href: '/manual/planar-calibration#polynomial' },
      { title: 'Persistence & Caching', href: '/manual/planar-calibration#persistence' },
  ...
  },
  {
    ...
    subsections: [
      ...
      { title: 'Stereo Stepped', href: '/manual/stereo-calibration#stepped' },
  ...
  },
  {
    ...
    subsections: [
      ...
      { title: 'Joint Multi-Camera Model', href: '/manual/global-coordinates#joint' },
      { title: 'Guided Wizard', href: '/manual/global-coordinates#wizard' },
      { title: 'Global Frame (Scale Factor)', href: '/manual/global-coordinates#global-frame' },
  ...
  },
  {
    ...
    subsections: [
      ...
      { title: 'Build Tuning', href: '/manual/developer#build-tuning' },
